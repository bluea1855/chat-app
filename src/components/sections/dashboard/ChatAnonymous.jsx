  ...
  return (
    ...
    >
      <div className="flex flex-col justify-center items-center">
        ...
        {!hideButton && (
          <>
            <div className="p-2 font-mono text-2xl flex flex-col justify-center items-start
              gap-3 m-3"></div>
            ...
            <div className="flex flex-row justify-between items-center gap-2 w-full mt-4">
              {/* <button className="bg-purple-400 w-full p-4 rounded-2xl"> */}
                <Link to="/chat" className="bg-purple-400 border-2 border-purple-400 font-semibold hover:text-purple-400 hover:bg-white w-full p-4 text-center rounded-2xl">
                Get Started
                </Link>
              {/* </button> */}
            </div>
