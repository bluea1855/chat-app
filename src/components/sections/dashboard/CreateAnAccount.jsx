  ...
  return (
    ...
    >
      <div className="flex flex-col justify-center items-center">
        ...
        {!hideButton && (
          <>
            <div className="p-2 font-mono text-2xl flex flex-col justify-center 
            items-start gap-3 m-3"></div>
            ...
            <div className="flex flex-row justify-between items-center gap-2 w-full mt-4">
              <Link to="/sign-up" className="bg-red-600 border-2 border-red-600 hover:bg-white hover:text-red-600 w-full p-3 text-center font-semibold rounded-2xl">
                Get Started
              </Link>
            </div>
          </>
