...
export default function ChatRoom() {
  ...
  return (
    <div className={state? 'flex flex-col justify-start gap-3 items-center w-full p-5  bg-gradient-to-l bg-white':'flex flex-col justify-start gap-3 items-center w-full p-5  bg-gradient-to-l bg-black text-white'}>
      <div className='ml-auto cursor-pointer'>
        {state? <FaToggleOn  size={32} onClick={handleToggle}/>:<FaToggleOff className='text-white' size={32} onClick={handleToggle}/>}
      </div>
      <ChatRoomHeader />
